...
import { FiHome, FiBook, FiPackage, FiDownload, FiHeart, FiStar, FiUser, FiSettings, FiLogOut, FiMenu, FiX, FiChevronRight, FiBell, FiVideo, FiAward, FiCreditCard, FiShield } from "react-icons/fi";
            ...
            <aside className="hidden lg:flex flex-col w-72 bg-white border-r border-gray-200 sticky top-0 h-screen">
                <div className="p-6 border-b border-gray-100">
                    <Link href="/" className="flex items-center gap-3">
                        ...
                        <span className="font-bold text-xl text-gray-900 dark:text-white">{theme?.logoText || "Student Hub"}</span>
                    </Link>
                </div>
                    ...
                    {userMenuItems.map((item) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                {isActive && <FiChevronRight size={16} />}
                            </Link>
                        );
                    })}
                </div>
            ...
            <div className="flex-1 flex flex-col min-w-0">
                ...
                <header className="h-16 bg-white/80 backdrop-blur-md border-b border-gray-200 flex items-center justify-between px-4 lg:px-8 sticky top-0 z-30">
                    ...
                    <div className="flex items-center gap-2 md:gap-4">
                        <Link href="/dashboard/user/notifications" className="p-2 text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-full relative">
                            <FiBell size={20} />
