    ...
    useEffect(() => {
        const fetchCategories = async () => {
            try {
                ...
                if (res.success) {
                    setCategories(res.data?.filter(c => c.type === "course") || []);
                }
            } catch { /* ignore */ }
        };
        fetchCategories();
    ...
    return (
        <div className="p-6 lg:p-8">
            ...
            <div className="flex items-center gap-4 mb-8">
                <Link href="/dashboard/admin/courses" className="btn btn-ghost p-3 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-800">
                    <FiArrowLeft size={20} />
                </Link>
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500">Add a new course to the LMS platform</p>
                    </div>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                {activeTab === "media" && (
                    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="card p-6 space-y-6 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-400 mt-1">Used on course detail page header</p>
                        </div>
                ...
                <div className="flex gap-4 mt-8">
                    <Link href="/dashboard/admin/courses" className="btn btn-ghost flex-1 py-4">Cancel</Link>
