...
export default function CategoryPage() {
    ...
    // Product type options - Simplified
    const productTypes = [
        { value: "all", label: "All", icon: FiGrid },
        { value: "graphics", label: "Graphics Templates", icon: FiImage },
        { value: "ux", label: "UX Templates", icon: FiLayout },
        { value: "course", label: "Courses", icon: FiBook },
    ];
