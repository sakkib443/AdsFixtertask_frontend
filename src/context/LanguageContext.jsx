...
const translations = {
    en: {
        ...
        filter: "Filter",
        sort: "Sort",
        searchPlaceholder: "Search design, courses...",
        ...
        fontHeroDesc: "Discover the perfect typography for your projects. Handwritten, Serif, Display and more.",
        searchFonts: "Search fonts...",
        fontsFound: "fonts found",
        noFontsFound: "No fonts found",

        // UI Kits Page
        uiKitCollection: "UI/UX Kit Collection",
        premiumUIKits: "PREMIUM UI/UX KITS",
        uiKitHeroDesc: "Speed up development with premium UI components and design systems.",
        searchUIKits: "Search UI kits...",
        uiKitsFound: "UI kits found",
        noUIKitsFound: "No UI kits found",

        // Photos Page
        photoCollection: "Photo Collection",
        premiumPhotos: "PREMIUM PHOTOS",
        photoHeroDesc: "Discover high-quality stock photos and creative images for your projects.",
        ...
        videoTemplateCollection: "Video Template Collection",
        premiumVideoTemplates: "PREMIUM VIDEO TEMPLATES",
        videoHeroDesc: "Create professional videos with premium templates.",
        searchVideoTemplates: "Search video templates...",
        videosFound: "video templates found",
        noVideosFound: "No video templates found",

        // Audio Assets Page
        audioCollection: "Audio Asset Collection",
        premiumAudio: "PREMIUM AUDIO ASSETS",
        audioHeroDesc: "Discover high-quality sound effects and background music.",
        searchAudio: "Search audio...",
        audioFound: "audio assets found",
        noAudioFound: "No audio assets found",
        premiumWord: "PREMIUM",
        audioWord: "AUDIO",
        ...
        // App Templates Page
        appTemplateCollection: "App Template Collection",
        premiumAppTemplates: "PREMIUM APP TEMPLATES",
        appHeroDesc: "Launch your app faster with professional mobile and web templates.",
        searchAppTemplates: "Search app templates...",
        appsFound: "app templates found",
        noAppsFound: "No app templates found",
        appWord: "APP",
        android: "Android",
        ...
        // Graphics Page
        graphicsListingDescription: "Premium graphics and UI/UX templates for your creative projects. Logo, Banner, Dashboard, Mobile UI and more.",
        allTemplates: "All Templates",
        uxTemplates: "UX Templates",
        ...
        appSupported: "Application Supported",
        fileType: "File Type",
        oneGreatValue: "One great value asset from",
        by: "By",
        relatedProducts: "Related Products",
        similarProducts: "Similar Products",
        shareAsset: "Share Asset",
        productNotFound: "Product Not Found",
        browseGraphics: "Browse Graphics",
        ...
        heroDesigner: "Designer & Trainer",
        heroDesc: "Zayed Uddin is an instructor in Graphic and UX/UI Design at BASIS Institute of Technology and Management (BITM). Zayed Uddin is also an Instructor in the 'Post Graduate Diploma in Graphic Design' program at the 'Institute of Business and Economic Research (IBER)' under the United International University",
        heroDesign: "Design",
        heroDesignDesc: "Design Work means that portion of the Work consisting of the design services required...",
        heroTraining: "Training",
        heroTrainingDesc: "Workplace training is the process of developing knowledge, skills and efficiency in your job...",
    ...
    bn: {
        ...
        tryDifferentKeywords: "অন্যান্য কি-ওয়ার্ড দিয়ে চেষ্টা করুন",
        addedToCart: "কার্টে যুক্ত হয়েছে!",
        failedToAdd: "যুক্ত করতে ব্যর্থ হয়েছে",

        // Fonts Page
        fontCollection: "ফন্ট কালেকশন",
        premiumFonts: "প্রিমিয়াম ফন্টস",
        fontHeroDesc: "আপনার প্রজেক্টের জন্য সেরা টাইপোগ্রাফি খুঁজুন। হ্যান্ডরিটেন, সেরিফ, ডিসপ্লে এবং আরও অনেক কিছু।",
        searchFonts: "ফন্ট খুঁজুন...",
        fontsFound: "টি ফন্ট পাওয়া গেছে",
        noFontsFound: "কোন ফন্ট পাওয়া যায়নি",

        // UI Kits Page
        uiKitCollection: "ইউআই কিট কালেকশন",
        premiumUIKits: "প্রিমিয়াম ইউআই কিটস",
        uiKitHeroDesc: "প্রিমিয়াম ইউআই কম্পোনেন্ট এবং ডিজাইন সিস্টেম দিয়ে আপনার কাজকে ত্বরান্বিত করুন।",
        searchUIKits: "ইউআই কিট খুঁজুন...",
        uiKitsFound: "টি ইউআই কিট পাওয়া গেছে",
        noUIKitsFound: "কোন ইউআই কিট পাওয়া যায়নি",

        // Photos Page
        photoCollection: "ফটো কালেকশন",
        premiumPhotos: "প্রিমিয়াম ফটোস",
        photoHeroDesc: "আপনার প্রজেক্টের জন্য উচ্চমানের স্টক ফটো এবং ক্রিয়েটিভ ছবি খুঁজুন।",
        searchPhotos: "ফটো খুঁজুন...",
        stock: "স্টক",
        photos: "ফটোস",
        photosFound: "টি ফটো পাওয়া গেছে",
        noPhotosFound: "কোন ফটো পাওয়া যায়নি",
        ...
        // Video Templates Page
        videoTemplateCollection: "ভিডিও টেমপ্লেট কালেকশন",
        premiumVideoTemplates: "প্রিমিয়াম ভিডিও টেমপ্লেটস",
        videoHeroDesc: "প্রিমিয়াম টেমপ্লেট দিয়ে পেশাদার মানের ভিডিও তৈরি করুন।",
        searchVideoTemplates: "ভিডিও টেমপ্লেট খুঁজুন...",
        videosFound: "টি ভিডিও টেমপ্লেট পাওয়া গেছে",
        noVideosFound: "কোন ভিডিও টেমপ্লেট পাওয়া যায়নি",

        // Audio Assets Page
        audioCollection: "অডিও অ্যাসেট কালেকশন",
        premiumAudio: "প্রিমিয়াম অডিও অ্যাসেটস",
        audioHeroDesc: "উচ্চমানের সাউন্ড ইফেক্ট এবং ব্যাকগ্রাউন্ড মিউজিক খুঁজুন।",
        searchAudio: "অডিও খুঁজুন...",
        audioFound: "টি অডিও অ্যাসেট পাওয়া গেছে",
        noAudioFound: "কোন অডিও অ্যাসেট পাওয়া যায়নি",
        premiumWord: "প্রিমিয়াম",
        audioWord: "অডিও",
        ...
        poster: "পোস্টার",
        flyer: "ফ্লায়ার",
        socialMediaWord: "সোশ্যাল মিডিয়া",
        ...
        // App Templates Page
        appTemplateCollection: "অ্যাপ টেমপ্লেট কালেকশন",
        premiumAppTemplates: "প্রিমিয়াম অ্যাপ টেমপ্লেটস",
        appHeroDesc: "পেশাদার মোবাইল ও ওয়েব টেমপ্লেট দিয়ে দ্রুত অ্যাপ লঞ্চ করুন।",
        searchAppTemplates: "অ্যাপ টেমপ্লেট খুঁজুন...",
        appsFound: "টি অ্যাপ টেমপ্লেট পাওয়া গেছে",
        noAppsFound: "কোন অ্যাপ টেমপ্লেট পাওয়া যায়নি",
        appWord: "অ্যাপ",
        android: "অ্যান্ড্রয়েড",
        reactNative: "রিঅ্যাক্ট নেটিভ",
        flutter: "ফ্লাটার",
        webApp: "ওয়েব অ্যাপ",

        // Graphics Page
        graphicsListingDescription: "আপনার সৃজনশীল প্রকল্পের জন্য প্রিমিয়াম গ্রাফিক্স এবং UI/UX টেমপ্লেট। লোগো, ব্যানার, ড্যাশবোর্ড, মোবাইল UI এবং আরও অনেক কিছু।",
        allTemplates: "সব টেমপ্লেট",
        uxTemplates: "ইউআই/ইউএক্স টেমপ্লেট",
        templatesFound: "টি টেমপ্লেট পাওয়া গেছে",
        noTemplatesFound: "কোন টেমপ্লেট পাওয়া যায়নি",
        ...
        appSupported: "সাপোর্টেড অ্যাপ্লিকেশান",
        fileType: "ফাইলের ধরন",
        oneGreatValue: "অসাধারণ একটি অ্যাসেট",
        by: "কর্তৃক",
        relatedProducts: "সম্পর্কিত পণ্য",
        similarProducts: "অনুরূপ পণ্য",
        shareAsset: "শেয়ার করুন",
        productNotFound: "প্রোডাক্ট পাওয়া যায়নি",
        browseGraphics: "গ্রাফিক্স দেখুন",
        uxui: "UX/UI ডিজাইন",
        branding: "ব্র্যান্ডিং ডিজাইন",
        ...
        filter: "ফিল্টার",
        sort: "সর্ট",
        searchPlaceholder: "ডিজাইন, কোর্স খুঁজুন...",
        mostPopular: "জনপ্রিয়",
        newest: "নতুন",
        ...
        selectPayment: "পেমেন্ট মেথড সিলেক্ট করুন",
        secureSSL: "নিরাপদ • SSL",
        couponCode: "কুপন কোড",
        apply: "প্রয়োগ করুন",
        continueShopping: "শপিং চালিয়ে যান",
        remove: "মুছে ফেলুন",
        clear: "ক্লিয়ার",
        itemsInCart: "টি আইটেম কার্টে আছে",
        graphicTemplates: "গ্রাফিক টেমপ্লেট",
        videoTemplates: "ভিডিও টেমপ্লেট",
        audioAssets: "অডিও অ্যাসেট",
        photoAssets: "ফটো অ্যাসেট",
        appTemplates: "অ্যাপ টেমপ্লেট",
        fontsSection: "ফন্ট ও টাইপোগ্রাফি",
        ...
        heroWith: "সাথে",
        heroAbuSayeed: "জায়েদ উদ্দিন",
        heroDesigner: "ডিজাইনার এবং ট্রেইনার",
        heroDesc: "জায়েদ উদ্দিন বেসিস ইনস্টিটিউট অফ টেকনোলজি অ্যান্ড ম্যানেজমেন্ট (BITM)-এ গ্রাফিক এবং UX/UI ডিজাইনের একজন প্রশিক্ষক। জায়েদ উদ্দিন ইউনাইটেড ইন্টারন্যাশনাল ইউনিভার্সিটির অধীনে 'ইনস্টিটিউট অফ বিজনেস অ্যান্ড ইকোনমিক রিসার্চ (IBER)'-এ 'পোস্ট গ্রাজুয়েট ডিপ্লোমা ইন গ্রাফিক ডিজাইন' প্রোগ্রামের একজন প্রশিক্ষক।",
        heroDesign: "ডিজাইন",
        heroDesignDesc: "ডিজাইন কাজ মানে কাজের সেই অংশ যা প্রয়োজনীয় ডিজাইন পরিষেবা নিয়ে গঠিত...",
        heroTraining: "ট্রেনিং",
        heroTrainingDesc: "কর্মক্ষেত্রে প্রশিক্ষণ হল আপনার কাজে জ্ঞান, দক্ষতা এবং দক্ষতা বিকাশের প্রক্রিয়া...",
...
export function LanguageProvider({ children }) {
    ...
    const toggleLanguage = () => {
        ...
        // Use toast directly here if possible
        import('react-hot-toast').then(m => {
            m.default.success(newLang === 'en' ? 'Language switched to English' : 'ভাষা পরিবর্তন করা হয়েছে');
        });
    };
